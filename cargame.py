...
car = Entity(model='quad', collider='box', scale=(2,1), rotation_z=-90, y = -3)

road1 = Entity(model='quad', scale=15, z=1)
...
def newEnemy():
  ...
  new = duplicate(car, x = 2*val, y = 25, color=color.random_color(),
